          ...
          <div className="mx-auto md:w-2/3 lg:w-1/2">
            <div className="-m-2 flex flex-wrap">
              ...
              <div className="w-full p-2">
                <button className="mx-auto bg-primaryColor text-primaryText  flex rounded border-0 bg-indigo-500 py-2 px-8 text-lg text-white hover:bg-indigo-600 focus:outline-none">
                  Send
                </button>
              </div>
              {/* footer */}
              <div className="mt-8 w-full border-t border-gray-800 p-2 pt-8 text-center">
                <a className="text-indigo-400">shakilahmmed8882@gmail.com</a>
